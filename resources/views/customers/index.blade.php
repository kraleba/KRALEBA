...
@section('content')
    ...
    <div class="row searchFilter-custom round3">
        ...
        <div class=" filter-customers col-lg-12">
            ...
            <form action="{{ route('customers.index') }}" method="get">
                <div>
                    <a class="add" href="{{ route('customers.create') }}"> ADD CLIENT</a>
                </div>
                    ...
                    <div>
                        <div>
                            <select name="type" id="department" class="form-control filter-control group">
                                <option selected value> -- Select the tipe --</option>
    ...
    <div class="clintes">
        @if ($customers)
            <div>
                <h4 class="filter-selection"> {{ $filter_title ?? 'Toti clientii:' }}</h4>
            </div>
        @endif
