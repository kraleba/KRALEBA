...
var childCounter = 0;
//event listener pentru butonul de adaugare copil
$("#add-child-button").on("click", function () {
    //incrementeaza contorul
    childCounter++;
    //adauga un nou div cu campurile pentru copil
    $("#children-fields").append(`
      <div class="child-field">
          <input type="text" name="children[${childCounter}][name]" placeholder="Nume copil">
          <input type="text" name="children[${childCounter}][age]" placeholder="Varsta copil">
...
//event listener pentru butonul de adaugare categorie
$("#children-fields").on("click", ".add-category-button", function () {
    var categoryCounter = $(this).siblings('.category-fields').children().length;
    $(this).siblings('.category-fields').append(`
      <div class="category<input type="text" name="children[${childCounter}][categories][${categoryCounter}][name]" placeholder="Nume categorie">
      <input type="text" name="children[${childCounter}][categories][${categoryCounter}][description]" placeholder="Descriere categorie">
  `);
});
