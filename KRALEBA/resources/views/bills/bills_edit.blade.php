            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong><i class="fa fa-asterisk" style="font-size:7px;color:red; vertical-align: top;"></i>Client Name:</strong>
                        <input type="text" name="name" value="{{ $bill->name }}" class="form-control" placeholder="Client">
                        @error('Name Client')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="email" name="number" class="form-control" placeholder="Cod" value="{{ $bill->cod }}">
                        @error('Cod')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="data facturarii" value="{{ $bill->address }}" class="form-control" placeholder="Data Facturarii:">
