...
@section('content')
    ...
    <div>
        <form action="{{ route('wares.update', ['customer_id'=>$customer['customer_id'], 'ware'=>$ware['id']]) }}" method="POST">
            @csrf
            @method('PUT')
            <div>
                ...
                <select id="subcategorySelected" name="subcategory_id" onchange="showWareTemplate()" class="form-control filter-control">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_name" class="form-control" value="{{$ware['product_name'] ?? ''}}" placeholder="Product Name">
                            @error('Product name')
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="custom_code" class="form-control" value="{{$ware['custom_code'] ?? ''}}" placeholder="Custom code">
                            @error('Custom code')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="composition" class="form-control" value="{{$ware['composition'] ?? ''}}" placeholder="Composition">
                                @error('Composition')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong><i class="fa fa-asterisk"
                                           style="font-size:7px;color:red; vertical-align: top;"></i>Weight in g/m2:</strong>
                                <input type="text" name="weight_in_g/m2" class="form-control" value="{{$ware['weight_in_g/m2'] ?? ''}}"  placeholder="Weight in g/m2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong><i class="fa fa-asterisk"
                                           style="font-size:7px;color:red; vertical-align: top;"></i>Width (cm):</strong>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong><i class="fa fa-asterisk"
                                           style="font-size:7px;color:red; vertical-align: top;"></i>Yarn number warp:</strong>
