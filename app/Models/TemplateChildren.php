...
class TemplateChildren extends Model
{
    protected $table = 'template_children';
    ...
    {
        return $this->belongsTo(TemplateParents::class, 'parent_id');
    }

    public function categories()
    {
        return $this->hasMany(TemplateChildCategories::class, 'child_id');
    }
